...
export default function Pergunta32({route}){
    ...
    return(
        <View>
            <ScrollView contentContainerStyle={localStyles.container}>
                <View>
                    <Text style={GlobalStyles.pergunta}>2. Você convive bastante com amigos e familiares, gosta de estar cercado das pessoas queridas?</Text>
                </View>
                ...
                <View style={GlobalStyles.botoesTeste}>
                    ...
                    <BotaoPeqProx title='Próximo' onPress={() => {
                        if(umAtivado == false && doisAtivado == false){
                            ...
                            navigation.navigate('Teste3R2', {resposta: umAtivado? resultado+=1 : resultado})}}
                        }/>
                </View>
            </ScrollView>
        </View>
