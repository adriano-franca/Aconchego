...
export default function Pergunta212({route}){
    ...
    return(
        <View style={localStyles.container}>
            ...
            <View style={localStyles.container2}>
                <Text style={GlobalStyles.pergunta}>12. É incapaz de desempenhar um papel útil em sua vida?</Text>
            </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                ...
                <BotaoPeqProx title='Próximo' onPress={() => {
                    ...
                    navigation.navigate('Teste2P13', {respostas: respostas})}}
                    }/>
            </View>
        </View>
    )
