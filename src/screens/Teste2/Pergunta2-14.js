...
export default function Pergunta214({route}){
    ...
    return(
        <View style={localStyles.container}>
            ...
            <View style={localStyles.container2}>
                <Text style={GlobalStyles.pergunta}>14. Você se sente uma pessoa inútil, sem préstimo?</Text>
            </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                ...
                <BotaoPeqProx title='Próximo' onPress={() => {
                    ...
                    navigation.navigate('Teste2P15', {respostas: respostas})}}
                    }/>
            </View>
        </View>
    )
