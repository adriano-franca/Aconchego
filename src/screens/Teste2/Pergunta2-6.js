...
export default function Pergunta26({route}){
    ...
    return(
        <View style={localStyles.container}>
            ...
            <View style={localStyles.container2}>
                <Text style={GlobalStyles.pergunta}>6. Tem má disgestão?</Text>
            </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste2P5')} />
                <BotaoPeqProx title='Próximo' onPress={() => {
                    ...
                    navigation.navigate('Teste2P7', {respostas: respostas})}}
                    }/>
            </View>
        </View>
    )
