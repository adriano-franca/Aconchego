...
import { View, Image, Text, StyleSheet, Dimensions, ScrollView, Alert, BackHandler  } from 'react-native'
...
export default function Pergunta213({route}){
    ...
    return(
        <View style={localStyles.container}>
            ...
            <View style={localStyles.container2}>
                <Text style={GlobalStyles.pergunta}>13. Tem perdido interesse pelas coisas?</Text>
            </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste2P12')}/>
                <BotaoPeqProx title='Próximo' onPress={() => {
                    ...
                    navigation.navigate('Teste2P14', {respostas: respostas})}}
                    }/>
            </View>
        </View>
    )
