...
export default function Pergunta29({route}){
    ...
    return(
        <View style={localStyles.container}>
            ...
            <View style={localStyles.container2}>
                <Text style={GlobalStyles.pergunta}>9. Encontra dificuldades para realizar com satisfação suas atividades diárias?</Text>
            </View>
            ...
            <View style={GlobalStyles.botoesTeste}>
                <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste2P8')}/>
                <BotaoPeqProx title='Próximo' onPress={() => {
                    ...
                    navigation.navigate('Teste2P10', {respostas: respostas})}}
                    }/>
            </View>
        </View>
    )
