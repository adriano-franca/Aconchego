...
export default function Pergunta118(props){
        ...
        <View style={localStyles.container}>
            <ScrollView>
                <View style={localStyles.container2}>
                    <Text style={GlobalStyles.pergunta}>18. Senti que estava um pouco emotivo/sensível demais</Text>
                </View>
                ...
                <View style={GlobalStyles.botoesTeste}>
                    <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P17', {respostas: respostas})} />
                    <BotaoPeqProx title='Próximo' onPress={() => {
                        ...
                        }else{navigation.navigate('Teste1P19', {respostas: respostas})}}}/>
                </View>
        </View>
    )
}
