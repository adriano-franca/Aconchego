...
export default function Pergunta119(props){
        ...
        <View style={localStyles.container}>
            <ScrollView>
                <View style={localStyles.container2}>
                    <Text style={GlobalStyles.pergunta}>19. Sabia que meu coração estava alterado mesmo não tendo feito nenhum esforço físico (ex: aumento de frequência cardíaca)</Text>
                </View>
                ...
                <View style={GlobalStyles.botoesTeste}>
                    <BotaoPeqVol title='Voltar' onPress={() => navigation.navigate('Teste1P18', {respostas: respostas})} />
                    <BotaoPeqProx title='Próximo' onPress={() => {
                        ...
                        }else{navigation.navigate('Teste1P20', {respostas: respostas})}}}/>
                </View>
        </View>
    )
}
